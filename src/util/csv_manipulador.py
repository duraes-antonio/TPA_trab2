...
def convert_pessoas_arq(path_saida: str, pessoas: List[Pessoa]):
	"""
	Converte uma lista de Pessoa em um arquivo CSV semelhante ao de entrada
	:param path_saida: Caminho do arquivo de saída (com nome do arquivo incluso)
	:param pessoas: Lista de pessoas a serem escritas no arquivo
	"""
